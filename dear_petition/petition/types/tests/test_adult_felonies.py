...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            datetime(2014, 8, 1),
            False,
        ),  # exclude because not Portal guilty disposition method
        (
            "",
            "District Guilty - Judge",
            SEVERITIES.MISDEMEANOR,
            datetime(2014, 8, 1),
            False,
        ),  # exclude because misdemeanor severity
        (
            "",
            "District Guilty - Judge",
            SEVERITIES.FELONY,
        ...
        (
            ...
            datetime(2014, 8, 1),
            False,
        ),  # exclude because not convicted action
        (
            CONVICTED,
            "Disposed By Judge",
            SEVERITIES.MISDEMEANOR,
...
def test_adult_felonies(
    action, disposition_method, severity, date, should_be_included, batch, record1
):
